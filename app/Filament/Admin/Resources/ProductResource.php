        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('image')
                    ->formatStateUsing(fn ($state):HtmlString => new HtmlString('<img src='.asset('uploads/thumb-'.$state).' alt="category-image" style="height: 2.5rem;" lazy="loading"/>')),
...
//                ,
                ...
                Tables\Columns\TextColumn::make('purchased')
                    ->formatStateUsing(fn ($state) => \Illuminate\Support\Number::format($state, maxPrecision: 2))
                    ->toggleable()
                    ->sortable(),
                ...
                ActionGroup::make([
                    ...
                    \App\Helper\Actions::CustomDelete()->action(function ($record) {
                        try {
                            ...
                            if ($record->delete()) {
                                FileHelper::deleteFile($record->video);
                                FileHelper::deleteFile($record->video_thumb);
...
//            VariantRelationManager::class,
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => \App\Filament\Admin\Resources\ProductResource\Pages\ViewProduct::route('/{record}/view'),
        ];
    }
