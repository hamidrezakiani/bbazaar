...
class ProductDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return[
            ...
            'purchased' => $this->purchased ? ($request->header('currency') ?? 'AFN') == 'AFN' ? $this->purchased : (number_format($this->purchased / getDollar()->price, 2, '.', '')) : $this->purchased,
            'image' => $this->image,
            'video' => $this->video,
            ...
            'images' => $this->product_image_names
        ];
