                ...
                <div class="grid gap-6 sm:grid-cols-1 xl:grid-cols-1">
                    <div class="mt-4 flex space-x-4 overflow-x-auto px-4 pb-4 sm:px-5 focus:scroll-auto">
                        @foreach($products as $product)
                            <a href="{{ App\Filament\Admin\Resources\ProductResource::getUrl('edit', ['record' => $product->id]) }}">
                                <div class="flex w-72 shrink-0 flex-col">
                                    <img class="h-60 w-full rounded-2xl object-cover object-center"
                                    ...
                                    <span class="text-base text-slate-700 dark:text-gray-100">
                                        ...
                                        <span class="text-danger-700">
                                            {{ Illuminate\Support\Number::format($product->total_price, maxPrecision: 2) . ' ' . \App\Helper\Setting::siteSetting()->currency_icon }}
                                        </span>
                                    </span>
                                            </p>
                                            <p class="mt-2">
